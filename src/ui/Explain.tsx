...
const GUIDES: Record<Route, Guide> = {
  ...
  servers: {
    ...
    actions: [
      ...
      ["u", "Update a site: PHP version or WordPress core"],
  ...
  stacks: {
    ...
    panes: [
      ["Groups", "App-type buckets; WordPress stacks expand by core version (newest highlighted), Non-WP into WHMCS / Laravel / …"],
    ...
    actions: [
      ...
      ["u", "Update a site: PHP version or WordPress core"],
      ["u (on a WP x.y.z row)", "Update WordPress on every site in that version group — canary first"],
  ...
  search: {
    ...
    actions: [
      ...
      ["o / w / u", "Open · open in SpinupWP · update PHP or WordPress"],
